#ifndef __itkLogDomainDemonsRegistrationWithMaskFilter_h
#define __itkLogDomainDemonsRegistrationWithMaskFilter_h
...
/**
 * \class LogDomainDemonsRegistrationWithMaskFilter
...
class ITK_EXPORT LogDomainDemonsRegistrationWithMaskFilter :
  public LogDomainDeformableRegistrationFilter<TFixedImage, TMovingImage, TField>
{
public:
  /** Standard class typedefs. */
  typedef LogDomainDemonsRegistrationWithMaskFilter                                        Self;
  ...
  itkTypeMacro( LogDomainDemonsRegistrationWithMaskFilter, LogDomainDeformableRegistrationFilter );
...
private:
  LogDomainDemonsRegistrationWithMaskFilter(const Self &); // purposely not implemented
...
#include "itkLogDomainDemonsRegistrationWithMaskFilter.hxx"
#endif
