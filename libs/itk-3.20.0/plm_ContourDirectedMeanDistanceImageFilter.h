/*=========================================================================
  ...
  Module:    $RCSfile: plm_ContourDirectedMeanDistanceImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __plm_ContourDirectedMeanDistanceImageFilter_h
#define __plm_ContourDirectedMeanDistanceImageFilter_h
...
/** \class plm_ContourDirectedMeanDistanceImageFilter 
 * \brief Computes the directed Mean distance between the boundaries of 
 * non-zero pixel regions of two images.
 *
 * plm_ContourDirectedMeanDistanceImageFilter computes the distance between the set
...
class ITK_EXPORT plm_ContourDirectedMeanDistanceImageFilter : 
    public ImageToImageFilter<TInputImage1, TInputImage1>
{
public:
  /** Standard Self typedef */
  typedef plm_ContourDirectedMeanDistanceImageFilter         Self;
  ...
  itkTypeMacro(plm_ContourDirectedMeanDistanceImageFilter, ImageToImageFilter);
...
protected:
  plm_ContourDirectedMeanDistanceImageFilter();
  ~plm_ContourDirectedMeanDistanceImageFilter(){};
...
private:
  plm_ContourDirectedMeanDistanceImageFilter(const Self&); //purposely not implemented
...
#include "plm_ContourDirectedMeanDistanceImageFilter.hxx"
#endif
