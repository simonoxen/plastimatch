#ifndef __itkSymmetricLogDomainDemonsRegistrationFilterWithMaskExtension_h
 ...
 * 						- using itk::ESMDemonsRegistrationWithMaskExtension
 */

template<class TFixedImage, class TMovingImage, class TField>
class ITK_EXPORT SymmetricLogDomainDemonsRegistrationFilterWithMaskExtension :
   public LogDomainDeformableRegistrationFilter<TFixedImage,TMovingImage,TField>
{
public:
  /** Standard class typedefs. */
  typedef SymmetricLogDomainDemonsRegistrationFilterWithMaskExtension    Self;
  ...
  itkTypeMacro( SymmetricLogDomainDemonsRegistrationFilterWithMaskExtension,LogDomainDeformableRegistrationFilter );
...
protected:
  SymmetricLogDomainDemonsRegistrationFilterWithMaskExtension();
  ~SymmetricLogDomainDemonsRegistrationFilterWithMaskExtension() {}
...
private:
  SymmetricLogDomainDemonsRegistrationFilterWithMaskExtension(const Self&); //purposely not implemented
...
#include "itkSymmetricLogDomainDemonsRegistrationFilterWithMaskExtension.txx"
#endif
