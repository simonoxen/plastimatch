 ...
 *
 *=========================================================================*/
#ifndef itkDiffeomorphicDemonsRegistrationWithMaskFilter_h
#define itkDiffeomorphicDemonsRegistrationWithMaskFilter_h
 ...
 * based on a variation of the DemonsRegistrationWithMaskFilter. The basic modification
...
public:
  ...
  itkTypeMacro(DiffeomorphicDemonsRegistrationWithMaskFilter, PDEDeformableRegistrationWithMaskFilter);
...
protected:
  ...
  ~DiffeomorphicDemonsRegistrationWithMaskFilter() ITK_OVERRIDE {}
...
private:
  ITK_DISALLOW_COPY_AND_ASSIGN(DiffeomorphicDemonsRegistrationWithMaskFilter);
