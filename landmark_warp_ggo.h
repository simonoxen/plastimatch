 ...
 */
int cmdline_parser_landmark_warp (int argc, char * const *argv,
 ...
 */
int cmdline_parser_landmark_warp2 (int argc, char * const *argv,
  struct args_info_landmark_warp *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_landmark_warp_ext (int argc, char * const *argv,
  struct args_info_landmark_warp *args_info,
