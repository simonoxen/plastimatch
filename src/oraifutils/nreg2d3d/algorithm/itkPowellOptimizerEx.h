...
//
// NOTE:
// This class is a simple extension of the original ITK class itk::PowellOptimizer
// in order to support stopping.
// @author phil
// @version 1.0
//
//
...
=========================================================================*/
#ifndef __itkPowellOptimizerEx_h
#define __itkPowellOptimizerEx_h
...
class ITK_EXPORT PowellOptimizerEx:
    public SingleValuedNonLinearOptimizer
{
public:
  /** Standard "Self" typedef. */
  typedef PowellOptimizerEx                Self;
  ...
  itkTypeMacro(PowellOptimizerEx, SingleValuedNonLinearOptimizer );
...
protected:
  PowellOptimizerEx();
  PowellOptimizerEx(const PowellOptimizerEx&);
  virtual ~PowellOptimizerEx();
