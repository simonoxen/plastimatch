...
=========================================================================*/
#ifndef __itkAmoebaOptimizerEx_h
#define __itkAmoebaOptimizerEx_h
...
/** \class AmoebaOptimizerEx
 * \brief Wrap of the vnl_amoeba algorithm
 *
 * AmoebaOptimizerEx is a wrapper around the vnl_amoeba algorithm which
 ...
 *
 * AmoebaOptimizerEx can only minimize a function.
 *
...
public:
  ...
  typedef AmoebaOptimizerEx                     Self;
  ...
  itkTypeMacro( AmoebaOptimizerEx, SingleValuedNonLinearVnlOptimizer );
  ...
  typedef   vnl_amoeba_ex             InternalOptimizerType;

  /** Method for getting access to the internal optimizer. */
  vnl_amoeba_ex * GetOptimizer(void);

  /** Start optimization with an initial value. */
  void StartOptimization( void );

  /** Stop optimization by stopping the internal VNL optimizer **/
...
protected:
  AmoebaOptimizerEx();
  virtual ~AmoebaOptimizerEx();
  void PrintSelf(std::ostream& os, Indent indent) const;

  typedef Superclass::CostFunctionAdaptorType   CostFunctionAdaptorType;

private:
  AmoebaOptimizerEx(const Self&); //purposely not implemented
