...
itk_dicom_save (
    ...
    const char *dir_name,                 /* Input: name of output dir */
    Rt_study_metadata *rsm,                /* In/out: slice uids get set */
	const char* patientName,	/*YKTEMP. only valid when rsm is null*/
	const char* patientID/*YKTEMP. only valid when rsm is null*/
)
{
    typedef itk::NumericSeriesFileNames NamesGeneratorType;
    const int export_as_ct = 1;
    ...
    */
	...
	//encapsulate (dict, "0010|0040", "O");
	/* Patient name */
	encapsulate (dict, "0010|0010", patientID); //YKTEMP
	/* Patient id */
	encapsulate (dict, "0010|0020", patientName); //YKTEMP
	/* Patient sex */
	encapsulate (dict, "0010|0040", "O");//YKTEMP
    }
