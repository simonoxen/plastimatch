 ...
 *           by SerieHelper2::AddRestriction()
 ...
 */
void SerieHelper2::AddRestriction(uint16_t group, uint16_t elem, 
 ...
 *                                 std::string const &value, int op);
 */
void SerieHelper2::AddRestriction(TagKey const &key, std::string const &value)
{
   Rule r;
   r.first = key;
   r.second = value;
 ...
 */
void SerieHelper2::SetDirectory(std::string const &dir, bool recursive)
{
 ...
 *          the best approach :)
 */
void SerieHelper2::OrderFileList(FileList *fileSet)
{

   if ( SerieHelper2::UserLessThanFunction )
   {
 ...
 */
FileList *SerieHelper2::GetFirstCoherentFileList()
{
 ...
 */
FileList *SerieHelper2::GetNextCoherentFileList()
{
 ...
 */
FileList *SerieHelper2::GetCoherentFileList(std::string SerieUID)
{
 ...
 */
FileList *SerieHelper2::GetNextSingleSerieUIDFileSet()
{
   gdcmAssertMacro (ItFileSetHt != SingleSerieUIDFileSetHT.end());
 ...
 */
FileList *SerieHelper2::GetSingleSerieUIDFileSet(std::string SerieUID)
{
   if ( SingleSerieUIDFileSetHT.count(SerieUID) == 0 )
      return 0;     
   return SingleSerieUIDFileSetHT[SerieUID];
...
XCoherentFileSetmap SerieHelper2::SplitOnOrientation(FileList *fileSet)
{
...
XCoherentFileSetmap SerieHelper2::SplitOnPosition(FileList *fileSet)
{
   XCoherentFileSetmap CoherentFileSet;
...
XCoherentFileSetmap SerieHelper2::SplitOnTagValue(FileList *fileSet, 
 ...
 */
bool SerieHelper2::ImagePositionPatientOrdering( FileList *fileList )
 ...
 */
bool SerieHelper2::ImageNumberOrdering(FileList *fileList) 
{
   int min, max, pos;
 ...
 * @return false only if the header is bugged !
 */
bool SerieHelper2::FileNameOrdering(FileList *fileList)
{
   SortFunctor sf;
   if (DirectOrder) 
      sf = FileNameLessThan;
 ...
 * @return false only if the header is bugged !
 */
bool SerieHelper2::UserOrdering(FileList *fileList)
{
   SortFunctor sf;
   sf = SerieHelper2::UserLessThanFunction;
   Sort(fileList,sf);
   if (!DirectOrder) 
   {
...
void SerieHelper2::CreateDefaultUniqueSeriesIdentifier()
{
