...
typedef void (*Bspline_score_function_k) (
...
/* This is version "k" of the template, based on MSE "c" */
template< Bspline_score_function_k bspline_score_function_k >
void
bspline_loop_k (Bspline_optimize *bod)
{
...
/* This is version "l" of the template, which is a merged version of 
   mse "c" and mi "c" */
template< class Bspline_loop_class >
void
bspline_loop_l (Bspline_optimize *bod, 
