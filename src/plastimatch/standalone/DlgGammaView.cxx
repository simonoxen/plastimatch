...
DlgGammaView::DlgGammaView(QWidget *parent): QDialog (parent)
{
 ...
 //   connect (ui.labelOverlapWnd3, SIGNAL(Mouse_Move()), this, SLOT(SLT_UpdateSplit3())); //added
	...
	//connect (ui.labelOverlapWnd1, SIGNAL(Mouse_Pressed_Left()), this, SLOT(test())); //added
	//connect (ui.labelOverlapWnd2, SIGNAL(Mouse_Pressed_Left()), this, SLOT(test())); //added
	//connect (ui.labelOverlapWnd3, SIGNAL(Mouse_Pressed_Left()), this, SLOT(test())); //added
...
void DlgGammaView::test()
{

}

//
//void DlgGammaView::TestDraw()
//{
...
//}
//
//void DlgGammaView::SLT_CrntPosGo()
//{       
...
//    //gamma_gui* pParent= (gamma_gui*)(this->parent());
//    /*whenFixedImgLoaded();
...
//
//
//void DlgGammaView::SLT_DrawImageWhenSliceChange()
//{
//    /*if (m_pParent == NULL)
//        return;	*/
//	if (!m_spFixed)
...
//void DlgGammaView::whenFixedImgLoaded()
//{
//  if (!m_spFixed)
//	return;
...
//}
//
//void DlgGammaView::whenMovingImgLoaded()
//{
//  //do nothing so far
...
//}
//
//void DlgGammaView::SLT_DrawImageInFixedSlice()//Display Swap here!
//{
...
//}
//
//void DlgGammaView::SLT_UpdateSplit1()//Mouse Move event
//{
//  int idx = 0;
...
//
//
//void DlgGammaView::SLT_UpdateSplit2()
//{
//  int idx = 1;
//  UpdateSplit(idx, ui.labelOverlapWnd2);
//
//}
//void DlgGammaView::SLT_UpdateSplit3()
//{
//  int idx = 2;  
...
//
//
//void DlgGammaView::UpdateSplit(int viewIdx, qyklabel* pOverlapWnd)
//{
//  int idx = viewIdx;
//
//  if (pOverlapWnd == NULL)
...
//void DlgGammaView::SLT_MouseWheelUpdate1()
//{  
...
//}
//
//void DlgGammaView::SLT_MouseWheelUpdate2()
//{
//  if (ui.checkBoxZoom->isChecked())
//  {
...
//}
//
//void DlgGammaView::SLT_MouseWheelUpdate3()
//{
//  if (ui.checkBoxZoom->isChecked())
//  {
...
//
////release everything
//void DlgGammaView::SLT_CancelMouseAction()
//{
//  for (int i = 0 ; i<3; i++)
//  {
...
//}
//
//void DlgGammaView::SLT_MousePressedLeft1()
//{   
//  m_bPressedLeft[0] = true;
//}
//
//void DlgGammaView::SLT_MousePressedLeft2()
//{ 
//  m_bPressedLeft[1] = true;
//}
//
//void DlgGammaView::SLT_MousePressedLeft3()
//{
//  m_bPressedLeft[2] = true;
//}
//
//
//void DlgGammaView::MousePressedRight(int wndIdx, qyklabel* pWnd)
//{
...
//}
//
//void DlgGammaView::SLT_MousePressedRight1()
//{
//  int idx = 0;
...
//}
//
//void DlgGammaView::SLT_MousePressedRight2()
//{
//  int idx = 1;
//  MousePressedRight(idx, ui.labelOverlapWnd2); 
//}
//
//void DlgGammaView::SLT_MousePressedRight3()
//{
//  int idx = 2;
...
//}
//
//void DlgGammaView::SLT_MouseReleasedLeft1()
//{  
//   m_bPressedLeft[0] = false;
//}
//
//void DlgGammaView::SLT_MouseReleasedLeft2()
//{ 
//  m_bPressedLeft[1] = false;
//}
//
//void DlgGammaView::SLT_MouseReleasedLeft3()
//{ 
//  m_bPressedLeft[2] = false;
//}
//
//void DlgGammaView::SLT_MouseReleasedRight1()
//{
//  m_bPressedRight[0] = false;
//}
//
//void DlgGammaView::SLT_MouseReleasedRight2()
//{
//  m_bPressedRight[1] = false;
//}
//
//void DlgGammaView::SLT_MouseReleasedRight3()
//{
//  m_bPressedRight[2] = false;
//}
//
//void DlgGammaView::SLT_ChangeView()
//{
...
//}
//
//void DlgGammaView::initOverlapWndSize()
//{
...
//}
//
//void DlgGammaView::shiftSliceSlider() //shift one slice slider information
//{
//  //to avoid first unnecessary action.
//  disconnect(ui.sliderPosDisp1, SIGNAL(valueChanged(int)), this, SLOT(SLT_DrawImageWhenSliceChange()));
//  disconnect(ui.sliderPosDisp2, SIGNAL(valueChanged(int)), this, SLOT(SLT_DrawImageWhenSliceChange()));
...
//}
//
//void DlgGammaView::updateSliceLabel()
//{
//
//  switch (m_enViewArrange)
//  {
...
//}
//
//void DlgGammaView::SLT_RestoreImageSingle()
//{
//  int mainWndIdx = 0;
...
//}
//
//void DlgGammaView::SLT_RestoreImageAll()
//{
//  for (int i = 0 ; i<3 ; i++)
//  {
...
//}
////Auto registration
//void DlgGammaView::SLT_DoRegistrationRigid()//plastimatch auto registration
//{
...
////  if (m_strPathCTSkin)
//
//  cout << "2: preprocessing for CBCT image before rigid body registration" << endl;
//
...
//	  ProcessCBCT_beforeAutoRigidRegi(filePathFixed, m_strPathCTSkin, filePathFixed_proc, fShift);
//	}
//	else if (finfoSkinFile2.exists())
//	{
//	  cout << "alternative skin file will be used" << endl;
//	  filePathFixed_proc = m_strPathPlastimatch + "\\" + "fixed_rigid_proc.mha"; //After autoRigidbody Regi	
//	  ProcessCBCT_beforeAutoRigidRegi(filePathFixed, strPathAlternateSkin, filePathFixed_proc, fShift);
//	}
//	else
//	{	
//	  cout << "CT skin file is not found. preprocessing will be skipped" << endl;
...
//
//	/*void DlgGammaView::GenPlastiRegisterCommandFile(QString strPathCommandFile, QString strPathFixedImg, QString strPathMovingImg,
...
//}
//
//bool DlgGammaView::eventFilter( QObject *target, QEvent *event )
//{
...
//}
//
//void DlgGammaView::childEvent( QChildEvent *event )
//{
...
//}
//
//void DlgGammaView::ImageManualMove( int direction, double resol )
//{
//  if (!m_spMoving)
//	return;  
//
...
//void DlgGammaView::ImageManualMoveOneShot(float shiftX, float shiftY, float shiftZ )//DICOM coordinate
//{
//    if (!m_spMoving)
//        return;
//
...
//
////Bring Focus
//void DlgGammaView::SLT_BringFocusToEnableArrow(bool bChecked)
//{
//  if (bChecked)
//	ui.labelDisp1->setFocus(); //if focus is in label, Key Event will trigger 51 (override)
//}
//
//void DlgGammaView::SLT_KeyMoving( bool bChecked )//Key Moving check box
//{
...
//}
//
//void DlgGammaView::AddImageToCombo(int comboIdx, enREGI_IMAGES option) //comboIdx 0: fixed, 1: moving
//{
//  switch(option)
//  {
...
//void DlgGammaView::SelectComboExternal(int idx, enREGI_IMAGES iImage)
//{
//  QComboBox* crntCombo;
//
//  if (idx  ==0)
...
//}
//
//void DlgGammaView::SLT_FixedImageSelected(QString selText)
//{
...
//}
//
//void DlgGammaView::SLT_MovingImageSelected(QString selText)
//{
...
//
//
//void DlgGammaView::LoadImgFromComboBox(int idx, QString& strSelectedComboTxt)// -->when fixed image loaded will be called here!
//{
...
//void DlgGammaView::UpdateListOfComboBox( int idx )
//{
//  QComboBox* crntCombo; 
//
//  if (idx == 0)  
...
//}
//
//void DlgGammaView::SLT_RestoreMovingImg()
//{
...
//
//
//void DlgGammaView::SLT_DoRegistrationDeform()
//{  
// if (!m_spFixed || !m_spMoving)
//	return;
//
...
//}
//
//void DlgGammaView::PreprocessCT() //CT preparation + CBCT preparation only, then show the registration DLG
//{
//
...
//}
//
////void DlgGammaView::plm_dmap_main( Dmap_parms* parms )
//void DlgGammaView::plm_dmap_main(QString& img_in_fn, QString& img_out_fn )
//{
...
//}
//
////void DlgGammaView::plm_threshold_main(Pcmd_threshold* parms)
//void DlgGammaView::plm_threshold_main(QString& strRange, QString& img_in_fn, QString& img_out_fn)
//{
//    /*if (parms == NULL)
//          return;*/
//
...
//}
//
////void DlgGammaView::plm_mask_main(Mask_parms* parms)
//void DlgGammaView::plm_mask_main(Mask_operation mask_option, QString& input_fn, QString& mask_fn, QString& output_fn, float mask_value)
//{
...
//
//
//void DlgGammaView::plm_expansion_contract_msk( QString& strPath_msk, QString& strPath_msk_exp_cont, double fExpVal )
//{
...
//void DlgGammaView::ProcessCBCT_beforeAutoRigidRegi(QString& strPathRawCBCT, QString& strPath_mskSkinCT, QString& strPathOutputCBCT, double* manualTrans3d)
//{ 
...
//void DlgGammaView::ProcessCBCT_beforeDeformRegi(QString& strPathRawCBCT, QString& strPath_mskSkinCT_manRegi, QString& strPathOutputCBCT, QString& strPathXFAutoRigid, bool bBubbleFilling)
//{
//  if (!m_pParent->m_spAutoRigidCT)
//	return;  
//
...
//}
//
//void DlgGammaView::plm_synth_trans_xf( QString& strPath_fixed, QString& strPath_out_xf, double transX, double transY, double transZ)
//{
...
//}
//
//void DlgGammaView::SLT_PreProcessCT()
//{
//  PreprocessCT();
//}
//
//void DlgGammaView::SetPlmOutputDir(QString& endFix)
//{
...
//}
//
//void DlgGammaView::init( QString& strDCMUID )
//{
...
//}
//
//void DlgGammaView::SLT_PassFixedImgForAnalysis()
//{
//  if (m_spFixed)  
...
//}
//
//void DlgGammaView::SLT_PassMovingImgForAnalysis()
//{
//  if (m_spMoving)
//	m_pParent->UpdateReconImage(m_spMoving, ui.comboBoxImgMoving->currentText());
//}
//
//void DlgGammaView::PostSkinRemovingCBCT( USHORT_ImageType::Pointer& spCBCT )
//{
//  if (!spCBCT)
//  {
...
//  QString strPath_mskSkinCT_autoRegi_exp = m_strPathPlastimatch + "/msk_skin_CT_autoRegi_exp.mha";  
//  QFileInfo maskInfo(strPath_mskSkinCT_autoRegi_exp);
//  if (!maskInfo.exists()) //if the mask file is not prepared, give up the skin removal
//  {
//	  cout << "Mask file is not prepared. Skip this macro" << endl;
//	  return;
//  }
//	
//
...
//  QString mask_fn = strPath_mskSkinCT_autoRegi_exp.toLocal8Bit().constData();
...
//}
//
//void DlgGammaView::CropSkinUsingRS( USHORT_ImageType::Pointer& spImgUshort, QString& strPathRS, double cropMargin )
//{
//  if (cropMargin != 0.0)
//  {
...
//}
//
//void DlgGammaView::SLT_ExchangeRawRef()
//{
//	
//
//}
//
//void DlgGammaView::SLT_DoRegistrationGradient()
//{
//    //1) Save current image files
//    if (!m_spFixed || !m_spMoving)
//        return;
...
//}
//
//VEC3D DlgGammaView::GetShiftValueFromGradientXForm(QString& filePath, bool bInverse)
//{
//    VEC3D resVal;
//    resVal.x = 0.0;
//    resVal.y = 0.0;
