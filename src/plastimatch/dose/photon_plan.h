/* -----------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------- */
#ifndef _photon_plan_h_
#define _photon_plan_h_
...
class PLMDOSE_API Photon_plan {
public:
    SMART_POINTER_SUPPORT (Photon_plan);
public:
    Photon_plan_private *d_ptr;
public:
    Photon_plan ();
    ~Photon_plan ();
    ...
    /* Set the CT volume for dose calculation.
       The Photon_plan takes ownership of this CT. */
