...
bool
Proton_pristine_peak::load (const char* fn)
{
    FILE* fp = fopen (fn, "r");
    char linebuf[128];
...
bool
Proton_pristine_peak::load_xio (const char* fn)
{
    int i, j;
    char* ptoken;
    char linebuf[128];
...
bool
Proton_pristine_peak::load_txt (const char* fn)
{
    char linebuf[128];
    FILE* fp = fopen (fn, "r");
