/*=========================================================================
  ...
  Module:    $RCSfile: plm_HausdorffDistanceImageFilter.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __plm_HausdorffDistanceImageFilter_hxx
...
plm_HausdorffDistanceImageFilter<TInputImage1, TInputImage2>
...
template<class TInputImage1, class TInputImage2>
const typename plm_HausdorffDistanceImageFilter<TInputImage1, TInputImage2>
::InputImage2Type *
plm_HausdorffDistanceImageFilter<TInputImage1, TInputImage2>
::GetInput2()
{
...
::GenerateData()
{
  ...
  typedef plm_DirectedHausdorffDistanceImageFilter<InputImage1Type,InputImage2Type>
    Filter12Type;
  ...
  typedef plm_DirectedHausdorffDistanceImageFilter<InputImage2Type,InputImage1Type>
    Filter21Type;
