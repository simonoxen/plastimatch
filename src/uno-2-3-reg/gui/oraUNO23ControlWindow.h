//
#ifndef ORAUNO23CONTROLWINDOW_H
#define ORAUNO23CONTROLWINDOW_H

#include <QtGui/QMainWindow>
#include <QMutex>
#include "ui_oraUNO23ControlWindow.h"
...
class UNO23Model;
class Task;
class UNO23TaskPresentationWidget;
...
public:
  /** Default constructor **/
  UNO23ControlWindow(QWidget *parent = 0);
  /** Destructor **/
  virtual ~UNO23ControlWindow();
...
protected:
  ...
  UNO23TaskPresentationWidget *m_StatusWidget;
  /** Map that connects the tool buttons with the render views **/
  QMap<QToolButton *, UNO23RenderViewDialog *> m_ToolButtonWindowMap;
  /** Map that stores the last (or desired) render window positions **/
  QMap<UNO23RenderViewDialog *, QRect *> m_LastRenderViewGeoms;
  /** Blocker flag **/
