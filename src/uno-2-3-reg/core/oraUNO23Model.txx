//
#ifndef ORAUNO23MODEL_TXX_
#define ORAUNO23MODEL_TXX_
...
bool UNO23Model::InstantiateMetrics(GenericRegistrationPointer nreg)
{
  if (!nreg)
    return false;
...
template<typename TVolumeComponentType>
void UNO23Model::ConfigureMetricComponent(itk::Object::Pointer metric,
...
template<typename TVolumeComponentType>
bool UNO23Model::InstantiateOptimizer(GenericRegistrationPointer nreg)
{
  if (!nreg)
    return false;
...
template<typename TVolumeComponentType>
bool UNO23Model::InitializeInternal()
{
...
template<typename TVolumeComponentType>
bool UNO23Model::DeinitializeInternal()
{
...
ITKVTKImage *
UNO23Model::CastImage(ITKVTKImage *image, std::vector<std::string> &args)
{
...
template<typename TComponentType>
ITKVTKImage *
UNO23Model::CropImage(ITKVTKImage *image, std::vector<std::string> &args)
{
...
template<typename TComponentType>
ITKVTKImage *
UNO23Model::UnsharpMaskImage(ITKVTKImage *image,
...
template<typename TComponentType>
ITKVTKImage *
UNO23Model::ResampleImage(ITKVTKImage *image, std::vector<std::string> &args)
{
...
template<typename TComponentType>
ITKVTKImage *
UNO23Model::RescaleImage(ITKVTKImage *image, std::vector<std::string> &args,
...
template<typename TComponentType>
ITKVTKImage *
UNO23Model::PreProcessImage(ITKVTKImage::ITKImagePointer image,
...
template<typename TComponentType>
ITKVTKImage *
UNO23Model::PostProcessImage(ITKVTKImage::ITKImagePointer image,
                            std::string configBaseKey, bool &error,
...
template<typename TVolumeComponentType>
bool UNO23Model::ExecuteRegistration()
{
...
template<typename TVolumeComponentType>
void UNO23Model::InitializeDynamicMetricProperties()
{
  typedef TVolumeComponentType VolumePixelType;
  typedef itk::Image<VolumePixelType, 3> VolumeImageType;
  typedef itk::Image<DRRPixelType, 2> DRR2DImageType;
...
template<typename TVolumeComponentType>
void UNO23Model::UpdateCurrentRegistrationParameters(bool stopRegistration,
...
template<typename TVolumeComponentType>
void UNO23Model::ComputeCurrentMovingImages()
{
...
template<typename TVolumeComponentType>
bool UNO23Model::GenerateAndSaveDRRs(std::string outputDir,
...
template<typename TVolumeComponentType>
bool UNO23Model::GenerateITFOptimizerConfiguration(std::string outputDir)
{
...
template<typename TVolumeComponentType>
bool
UNO23Model::ComputeCrossCorrelationInitialTransform(const unsigned int &index,
