...
UNO23RegistrationInitializationTask::UNO23RegistrationInitializationTask() :
    Task()
{
...
bool UNO23RegistrationInitializationTask::HasInput() const
{
...
bool UNO23RegistrationInitializationTask::Execute()
{
  m_CancelRequest = false;
...
bool UNO23RegistrationInitializationTask::Unexecute()
{
  m_CancelRequest = false;
  emit
  TaskStarted(true);
...
QString UNO23RegistrationInitializationTask::GetName()
{
...
void UNO23RegistrationInitializationTask::SetNames(
