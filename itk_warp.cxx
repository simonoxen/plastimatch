...
template plastimatch1_EXPORT ULongImageType::Pointer itk_warp_image (ULongImageType::Pointer im_in, DeformationFieldType::Pointer vf, int linear_interp, unsigned long default_val);
