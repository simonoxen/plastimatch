...
IF(NOT CUDA_INCLUDE_DIRS)
  FIND_PATH(CUDA_INCLUDE_DIRS cuda.h
...
ENDIF(NOT CUDA_CUT_INCLUDE_DIR)
...
IF(NVCC_EXECUTABLE AND CUDA_INCLUDE_DIRS AND CUDA_CUT_INCLUDE_DIR AND CUDA_LIBRARIES)
  SET(CUDA_FOUND TRUE)
ELSE(NVCC_EXECUTABLE AND CUDA_INCLUDE_DIRS AND CUDA_CUT_INCLUDE_DIR AND CUDA_LIBRARIES)
  SET(CUDA_FOUND FALSE)
ENDIF(NVCC_EXECUTABLE AND CUDA_INCLUDE_DIRS AND CUDA_CUT_INCLUDE_DIR AND CUDA_LIBRARIES)
