...
=========================================================================*/
#ifndef __itk_metric_h
#define __itk_metric_h
...
class ITK_EXPORT GCSMetric : 
    public ImageToImageMetric< TFixedImage, TMovingImage>
{
public:

  /** Standard class typedefs. */
  typedef GCSMetric    Self;
  ...
  itkTypeMacro(GCSMetric, ImageToImageMetric);
...
private:
  GCSMetric(const Self&); //purposely not implemented
...
// Use hxx extension to get highlighting in msdev
#include "gcs_metric.hxx"
#endif
