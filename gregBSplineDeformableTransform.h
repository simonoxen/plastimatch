...
#ifndef __gregBSplineDeformableTransform_h
#define __gregBSplineDeformableTransform_h
...
class ITK_EXPORT gregBSplineDeformableTransform : 
          public Transform< TScalarType, NDimensions, NDimensions >
{
public:
  /** Standard class typedefs. */
  typedef gregBSplineDeformableTransform Self;
  ...
  itkTypeMacro( gregBSplineDeformableTransform, Transform );
...
protected:
  ...
  virtual ~gregBSplineDeformableTransform();
...
private:
  gregBSplineDeformableTransform(const Self&); //purposely not implemented
...
#include "gregBSplineDeformableTransform.txx"
#endif
