/*
  ...
  /usr/bin/gengetopt --output-dir=/home/tshack/src/plastimatch/branches/tshack-testing --arg-struct-name=args_info_landmark_warp --func-name=cmdline_parser_landmark_warp --file-name=landmark_warp_ggo --unamed-opts --conf-parser --include-getopt -u --show-required --no-handle-error
...
static int
cmdline_parser_landmark_warp_internal (int argc, char * const *argv, struct args_info_landmark_warp *args_info,
...
int
cmdline_parser_landmark_warp (int argc, char * const *argv, struct args_info_landmark_warp *args_info)
{
  return cmdline_parser_landmark_warp2 (argc, argv, args_info, 0, 1, 1);
}

int
cmdline_parser_landmark_warp_ext (int argc, char * const *argv, struct args_info_landmark_warp *args_info,
                   struct cmdline_parser_landmark_warp_params *params)
{
  int result;
...
int
cmdline_parser_landmark_warp2 (int argc, char * const *argv, struct args_info_landmark_warp *args_info, int override, int initialize, int check_required)
{
  int result;
  struct cmdline_parser_landmark_warp_params params;
...
cmdline_parser_landmark_warp_internal (
  int argc, char * const *argv, struct args_info_landmark_warp *args_info,
                        struct cmdline_parser_landmark_warp_params *params, const char *additional_error)
{
