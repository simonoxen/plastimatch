/*
  ...
  /usr/bin/gengetopt --output-dir=/PHShome/gcs6/work/plastimatch --arg-struct-name=args_info_landmark_warp --func-name=cmdline_parser_landmark_warp --file-name=landmark_warp_ggo --unamed-opts --conf-parser --include-getopt -u --show-required --no-handle-error
...
const char *cmdline_parser_landmark_warp_algorithm_values[] = {"tps", "gauss", "wendland", 0}; /*< Possible values for algorithm. */
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'F':	/* Fixed image (match output size to this image).  */
          ...
          break;
        case 'a':	/* RBF warping algorithm .  */
        
        
          if (update_arg( (void *)&(args_info->algorithm_arg), 
               &(args_info->algorithm_orig), &(args_info->algorithm_given),
              &(local_args_info.algorithm_given), optarg, cmdline_parser_landmark_warp_algorithm_values, "gauss", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "algorithm", 'a',
              additional_error))
            goto failure;
        ...
        case 'Y':	/* Young modulus.  */
          ...
          break;
        case 'd':	/* Value to set for pixels with unknown value.  */
