/*
  ...
  /usr/bin/gengetopt --output-dir=/home/gsharp/work/plastimatch --arg-struct-name=args_info_landmark_warp --func-name=cmdline_parser_landmark_warp --file-name=landmark_warp_ggo --unamed-opts --conf-parser --include-getopt -u --show-required --no-handle-error
...
const char *args_info_landmark_warp_purpose = "";

const char *args_info_landmark_warp_usage = "Usage: landmark_warp [options]";

const char *args_info_landmark_warp_description = "";

const char *args_info_landmark_warp_full_help[] = {
  ...
  "  -v, --input-vf=filename       Input vector field",
  ...
  "  -a, --algorithm=STRING        Either \"itk\", \"gcs\", or \"nsh\"  \n                                  (default=`gcs')",
...
{
  args_info_landmark_warp_help[0] = args_info_landmark_warp_full_help[0];
  args_info_landmark_warp_help[1] = args_info_landmark_warp_full_help[1];
  args_info_landmark_warp_help[2] = args_info_landmark_warp_full_help[2];
  args_info_landmark_warp_help[3] = args_info_landmark_warp_full_help[3];
  args_info_landmark_warp_help[4] = args_info_landmark_warp_full_help[4];
  args_info_landmark_warp_help[5] = args_info_landmark_warp_full_help[5];
  args_info_landmark_warp_help[6] = args_info_landmark_warp_full_help[6];
  args_info_landmark_warp_help[7] = args_info_landmark_warp_full_help[7];
  args_info_landmark_warp_help[8] = args_info_landmark_warp_full_help[8];
  args_info_landmark_warp_help[9] = args_info_landmark_warp_full_help[9];
  args_info_landmark_warp_help[10] = args_info_landmark_warp_full_help[10];
  ...
  args_info_landmark_warp_help[13] = 0; 
  
}

const char *args_info_landmark_warp_help[14];
...
static
void clear_given (struct args_info_landmark_warp *args_info);
static
void clear_args (struct args_info_landmark_warp *args_info);

static int
cmdline_parser_landmark_warp_internal (int argc, char **argv, struct args_info_landmark_warp *args_info,
                        struct cmdline_parser_landmark_warp_params *params, const char *additional_error);

static int
cmdline_parser_landmark_warp_required2 (struct args_info_landmark_warp *args_info, const char *prog_name, const char *additional_error);
struct line_list
{
  char * string_arg;
...
void clear_args (struct args_info_landmark_warp *args_info)
{
  ...
  args_info->fixed_landmarks_arg = NULL;
  args_info->fixed_landmarks_orig = NULL;
  args_info->moving_landmarks_arg = NULL;
  args_info->moving_landmarks_orig = NULL;
  args_info->input_xform_arg = NULL;
  args_info->input_xform_orig = NULL;
  args_info->input_vf_arg = NULL;
  args_info->input_vf_orig = NULL;
  ...
  args_info->algorithm_arg = gengetopt_strdup ("gcs");
...
static
void init_args_info(struct args_info_landmark_warp *args_info)
{

  init_help_array(); 
  args_info->help_help = args_info_landmark_warp_full_help[0] ;
  args_info->full_help_help = args_info_landmark_warp_full_help[1] ;
  args_info->version_help = args_info_landmark_warp_full_help[2] ;
  ...
  args_info->input_vf_help = args_info_landmark_warp_full_help[6] ;
  ...
  args_info->config_help = args_info_landmark_warp_full_help[13] ;
  
}

void
cmdline_parser_landmark_warp_print_version (void)
{
  printf ("%s %s\n",
     (strlen(CMDLINE_PARSER_LANDMARK_WARP_PACKAGE_NAME) ? CMDLINE_PARSER_LANDMARK_WARP_PACKAGE_NAME : CMDLINE_PARSER_LANDMARK_WARP_PACKAGE),
     CMDLINE_PARSER_LANDMARK_WARP_VERSION);
}

static void print_help_common(void) {
  cmdline_parser_landmark_warp_print_version ();

  if (strlen(args_info_landmark_warp_purpose) > 0)
    printf("\n%s\n", args_info_landmark_warp_purpose);

  if (strlen(args_info_landmark_warp_usage) > 0)
    printf("\n%s\n", args_info_landmark_warp_usage);

  printf("\n");

  if (strlen(args_info_landmark_warp_description) > 0)
    printf("%s\n\n", args_info_landmark_warp_description);
}

void
cmdline_parser_landmark_warp_print_help (void)
{
  int i = 0;
  print_help_common();
  while (args_info_landmark_warp_help[i])
    printf("%s\n", args_info_landmark_warp_help[i++]);
}

void
cmdline_parser_landmark_warp_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (args_info_landmark_warp_full_help[i])
    printf("%s\n", args_info_landmark_warp_full_help[i++]);
}

void
cmdline_parser_landmark_warp_init (struct args_info_landmark_warp *args_info)
{
...
void
cmdline_parser_landmark_warp_params_init(struct cmdline_parser_landmark_warp_params *params)
{
  if (params)
    { 
      params->override = 0;
...
cmdline_parser_landmark_warp_params_create(void)
{
  struct cmdline_parser_landmark_warp_params *params = 
    (struct cmdline_parser_landmark_warp_params *)malloc(sizeof(struct cmdline_parser_landmark_warp_params));
  cmdline_parser_landmark_warp_params_init(params);  
  return params;
}
...
static void
cmdline_parser_landmark_warp_release (struct args_info_landmark_warp *args_info)
{
  unsigned int i;
  free_string_field (&(args_info->fixed_landmarks_arg));
  free_string_field (&(args_info->fixed_landmarks_orig));
  free_string_field (&(args_info->moving_landmarks_arg));
  ...
  free_string_field (&(args_info->input_vf_arg));
  free_string_field (&(args_info->input_vf_orig));
...
int
cmdline_parser_landmark_warp_dump(FILE *outfile, struct args_info_landmark_warp *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", CMDLINE_PARSER_LANDMARK_WARP_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->fixed_landmarks_given)
    write_into_file(outfile, "fixed-landmarks", args_info->fixed_landmarks_orig, 0);
  if (args_info->moving_landmarks_given)
  ...
  if (args_info->input_vf_given)
    write_into_file(outfile, "input-vf", args_info->input_vf_orig, 0);
  ...
  if (args_info->stiffness_given)
    write_into_file(outfile, "stiffness", args_info->stiffness_orig, 0);
...
int
cmdline_parser_landmark_warp_file_save(const char *filename, struct args_info_landmark_warp *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", CMDLINE_PARSER_LANDMARK_WARP_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = cmdline_parser_landmark_warp_dump(outfile, args_info);
  fclose (outfile);
...
void
cmdline_parser_landmark_warp_free (struct args_info_landmark_warp *args_info)
{
  cmdline_parser_landmark_warp_release (args_info);
}
...
int
cmdline_parser_landmark_warp (int argc, char **argv, struct args_info_landmark_warp *args_info)
{
  return cmdline_parser_landmark_warp2 (argc, argv, args_info, 0, 1, 1);
}

int
cmdline_parser_landmark_warp_ext (int argc, char **argv, struct args_info_landmark_warp *args_info,
                   struct cmdline_parser_landmark_warp_params *params)
{
  int result;
  result = cmdline_parser_landmark_warp_internal (argc, argv, args_info, params, 0);

  return result;
}

int
cmdline_parser_landmark_warp2 (int argc, char **argv, struct args_info_landmark_warp *args_info, int override, int initialize, int check_required)
{
  int result;
  struct cmdline_parser_landmark_warp_params params;
...
int
cmdline_parser_landmark_warp_required (struct args_info_landmark_warp *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (cmdline_parser_landmark_warp_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
...
cmdline_parser_landmark_warp_required2 (struct args_info_landmark_warp *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->fixed_landmarks_given)
    {
      fprintf (stderr, "%s: '--fixed-landmarks' ('-f') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  
  if (! args_info->moving_landmarks_given)
    {
      fprintf (stderr, "%s: '--moving-landmarks' ('-m') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
 ...
 * @param check_ambiguity @see cmdline_parser_landmark_warp_params.check_ambiguity
 * @param override @see cmdline_parser_landmark_warp_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               cmdline_parser_landmark_warp_arg_type arg_type,
...
int
cmdline_parser_landmark_warp_internal (
  int argc, char **argv, struct args_info_landmark_warp *args_info,
                        struct cmdline_parser_landmark_warp_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error = 0;
  struct args_info_landmark_warp local_args_info;
  ...
  if (initialize)
    cmdline_parser_landmark_warp_init (args_info);

  cmdline_parser_landmark_warp_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hf:m:x:v:I:O:V:a:r:Y:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          cmdline_parser_landmark_warp_print_help ();
          cmdline_parser_landmark_warp_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'f':	/* Input fixed landmarks.  */
        
        
          if (update_arg( (void *)&(args_info->fixed_landmarks_arg), 
               &(args_info->fixed_landmarks_orig), &(args_info->fixed_landmarks_given),
              &(local_args_info.fixed_landmarks_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'm':	/* Input moving landmarks.  */
        
        
          if (update_arg( (void *)&(args_info->moving_landmarks_arg), 
               &(args_info->moving_landmarks_orig), &(args_info->moving_landmarks_given),
              &(local_args_info.moving_landmarks_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "moving-landmarks", 'm',
              additional_error))
            goto failure;
          ...
          break;
        case 'x':	/* Input landmark xform.  */
        
        
          if (update_arg( (void *)&(args_info->input_xform_arg), 
               &(args_info->input_xform_orig), &(args_info->input_xform_given),
              &(local_args_info.input_xform_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "input-xform", 'x',
              additional_error))
            goto failure;
          ...
          break;
        case 'v':	/* Input vector field.  */
        
        
          if (update_arg( (void *)&(args_info->input_vf_arg), 
               &(args_info->input_vf_orig), &(args_info->input_vf_given),
              &(local_args_info.input_vf_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "input-vf", 'v',
              additional_error))
            goto failure;
        ...
        case 'I':	/* Input image to warp.  */
          ...
          if (update_arg( (void *)&(args_info->input_image_arg), 
               &(args_info->input_image_orig), &(args_info->input_image_given),
              &(local_args_info.input_image_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "input-image", 'I',
              additional_error))
            goto failure;
          ...
          break;
        case 'O':	/* Output warped image.  */
        
        
          if (update_arg( (void *)&(args_info->output_image_arg), 
               &(args_info->output_image_orig), &(args_info->output_image_given),
              &(local_args_info.output_image_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "output-image", 'O',
              additional_error))
            goto failure;
          ...
          break;
        case 'V':	/* Output vector field.  */
        
        
          if (update_arg( (void *)&(args_info->output_vf_arg), 
               &(args_info->output_vf_orig), &(args_info->output_vf_given),
        ...
        case 'a':	/* Either \"itk\", \"gcs\", or \"nsh\".  */
          ...
          break;
        case 'r':	/* Radius of radial basis function.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            cmdline_parser_landmark_warp_print_full_help ();
            cmdline_parser_landmark_warp_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", CMDLINE_PARSER_LANDMARK_WARP_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  if (check_required)
    {
      error += cmdline_parser_landmark_warp_required2 (args_info, argv[0], additional_error);
    }

  cmdline_parser_landmark_warp_release (&local_args_info);
...
static int
_cmdline_parser_landmark_warp_configfile (const char *filename, int *my_argc)
{
  FILE* file;
  ...
  while ((fgets(linebuf, CONFIG_FILE_LINE_SIZE, file)) != 0)
      ...
      if (len > (CONFIG_FILE_LINE_BUFFER_SIZE-1))
        {
          fprintf (stderr, "%s:%s:%d: Line too long in configuration file\n",
                   CMDLINE_PARSER_LANDMARK_WARP_PACKAGE, filename, line_num);
          result = EXIT_FAILURE;
          break;
        }
    ...
    noarg:
      if (!strcmp(fopt,"include")) {
        if (farg && *farg) {
          result = _cmdline_parser_landmark_warp_configfile(farg, my_argc);
        } else {
...
int
cmdline_parser_landmark_warp_configfile (
  const char *filename,
                           ...
                           int override, int initialize, int check_required)
{
  ...
  return cmdline_parser_landmark_warp_config_file (filename, args_info, &params);
}

int
cmdline_parser_landmark_warp_config_file (const char *filename,
                           struct args_info_landmark_warp *args_info,
                           struct cmdline_parser_landmark_warp_params *params)
{
  int i, result;
  ...
  cmd_line_list_tmp->next = cmd_line_list;
  cmd_line_list = cmd_line_list_tmp;
  cmd_line_list->string_arg = gengetopt_strdup (CMDLINE_PARSER_LANDMARK_WARP_PACKAGE);

  result = _cmdline_parser_landmark_warp_configfile(filename, &my_argc);
  ...
  if (result != EXIT_FAILURE) {
    ...
    result =
      cmdline_parser_landmark_warp_internal (my_argc, my_argv_arg, args_info,
                              params,
                              additional_error);
